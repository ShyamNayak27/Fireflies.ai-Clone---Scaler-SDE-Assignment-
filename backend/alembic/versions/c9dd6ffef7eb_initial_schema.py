...
def upgrade() -> None:
    ...
    sa.CheckConstraint("source IN ('upload','paste','manual','seed')", name='ck_meeting_source'),
    ...
    with op.batch_alter_table('action_items', schema=None) as batch_op:
        batch_op.create_index('ix_action_items_meeting', ['meeting_id', 'completed', 'position'], unique=False)
